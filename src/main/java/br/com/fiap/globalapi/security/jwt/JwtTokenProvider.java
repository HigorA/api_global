package br.com.fiap.globalapi.security.jwt;
...
public class JwtTokenProvider {
    ...
    private long validInMilliseconds = 36000000;
    ...
    public TokenVO createAcessToken(String username, List<String> roles, Long id) {
        Date now = new Date();
